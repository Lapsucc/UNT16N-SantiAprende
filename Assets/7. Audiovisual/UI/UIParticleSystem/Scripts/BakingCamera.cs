...
namespace Coffee.UIParticleExtensions
{
    ...
    internal class BakingCamera : MonoBehaviour
    {
        ...
        private static readonly Vector3 s_OrthoPosition = new(0, 0, -1000);
        ...
        private static BakingCamera Instance
        {
            ...
            {
#if UNITY_2018_3_OR_NEWER && UNITY_EDITOR
                BakingCamera inst = InstanceForPrefab;
                if (inst) return inst;
#endif
        ...
        {
            GameObject gameObject = new(typeof(BakingCamera).Name);

            // This camera object is just for internal use
            gameObject.hideFlags = HideFlags.HideAndDontSave;

            BakingCamera inst = gameObject.AddComponent<BakingCamera>();
        ...
        public static Camera GetCamera(Canvas canvas)
        {
            ...
            Quaternion rotation = canvas.renderMode != RenderMode.ScreenSpaceOverlay && camera
